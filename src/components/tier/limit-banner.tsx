...
export function TierLimitBanner({
  ...
  return (
    <div className="mx-auto max-w-lg">
      ...
      <div className="glass-card rounded-2xl border border-accent-orange/30 bg-accent-orange/[0.04] p-8">
        ...
        <p className="mb-6 text-sm text-white/60">
          ...
          . You currently have {current}. Upgrade to Pro or Business to unlock
          unlimited {resource} and team features.
        </p>
